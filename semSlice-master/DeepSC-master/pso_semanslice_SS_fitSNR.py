...
log_dir = f"./Records/semanslice/SS/fitSNR/{script_name}_{start_time}/"
...
from sem_slice_SS import main_compute
...
if __name__ == '__main__':
    ...
    results_dir = f"./Records/semanslice/SS/fitSNR/{script_name}_{start_time}/"
